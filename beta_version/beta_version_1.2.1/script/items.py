...
class Bandage(Prop):
    def __init__(self, GameVar, sprite, canvas):
        Prop.__init__(self,"Bandage","blue","None",None,GameVar,canvas)

class Crystal(NonEffect_M):
    def __init__(self,GameVar, sprite, canvas):
        NonEffect_M.__init__(self,"Crystal","green","None",None,GameVar,canvas)

class Stick(NonEffect_M):
    def __init__(self,GameVar, sprite, canvas):
        NonEffect_M.__init__(self,"Stick","green","None",None,GameVar,canvas)

class Rope(NonEffect_M):
    def __init__(self,GameVar,sprite,canvas):
        NonEffect_M.__init__(self,"Rope","green","None",None,GameVar,canvas)
...
class Items():
    def __init__(self,GameVar,canvas):
        ...
        self.crystal = Crystal(GameVar,self.resource1st,canvas)
        self.stick = Stick(GameVar,self.resource1st,canvas)
        self.rope = Rope(GameVar,self.resource1st,canvas)
